...
def pivot_and_normalize_edges_df(edges_df, score_col='jaccard', indexed=True, normalize_base_col=(1.0)):
    ...
    results = gt_edges_df.pivot(index=['edge', 'nb_name', 'gt_operation'], columns=['sampling'], values=score_col).dropna()
...
def main(args=sys.argv[1:]):
    ...
    os.makedirs('/tank/local/suhail/data/relic/relic_datasets_vldb_2021/analysis/dataset_flat_exact_sample_timing/', exist_ok=True)
